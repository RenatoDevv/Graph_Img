...
<head>
    ...
    <title>Product</title>
    <link rel="stylesheet"
        href="https://preview.keenthemes.com/preview/metronic/theme/html/demo1/dist/assets/plugins/global/plugins.bundle.css?v=7.2.9">
    <style>
        body {
            width: 100%;
            background: #ebebeb;
...
<body>
    <main>
        <h4 class="text-center mt-5">Lista de Servicios Graph Evolution</h4>

        <div class="container">
            <a href="" class="button-create btn">Nuevo Servicio</a>
                                ...
                                <a href=""><span
                                        class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Edit.svg--><svg
                                            ...
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                ...
                                                <rect fill="#3699FF" opacity="0.3" x="5" y="20" width="15"
                                                    height="2" rx="1" />
                                            </g>
                                        </svg><!--end::Svg Icon--></span></a>
                                <a href=""><span
                                        class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Home/Trash.svg--><svg
                                            xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            {{-- <span
                class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2021-05-14-112058/theme/html/demo1/dist/../src/media/svg/icons/Design/Component.svg--><svg
